    ...
    <td>
		...
		<?php 				
			...
			print("<thead><tr height='200px'>");
				print("<th bgcolor='#FFFFFF' style='height:205px; width:205px;'><img src='images/connectivity/spacer_first_cell_2.png' width='205px' height='205px' border='0'/></th>");				
				...
				for ($row=0; $row<$number_type; $row++) { //$number_type					
					...
					print ("<tr><td bgcolor='#E0FFFF' style='text-align:left; overflow:hidden; vertical-align:middle; width:205px; height:20px;'>");
					...
					if (strpos($subregion_nickname_type_row, '(+)') == TRUE)
						print ("<font style='font-size:10px' color='#339900'>$subregion_nickname_type_row</font>");
					if (strpos($subregion_nickname_type_row, '(-)') == TRUE)
						print ("<font style='font-size:10px' color='#CC0000'>$subregion_nickname_type_row</font>");							
